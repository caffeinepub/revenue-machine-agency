...
export class Backend implements backendInterface {
    ...
    async debugClearInquiries(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.debugClearInquiries();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async debugDeleteInquiry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.debugDeleteInquiry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async debugGetAllInquiries(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.debugGetAllInquiries();
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string | null, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
