...
const OFFERS: SpecialOffer[] = [
  {
    ...
    discount: "26% OFF",
    features: [
      "Social Media Management – Starter (₹3,999)",
  ...
  },
  {
    ...
    discount: "26% OFF",
    features: [
      "Complete Brand Identity Pack (₹5,999)",
      "WordPress Website Pack (₹8,999)",
  ...
  },
  {
    ...
    features: [
      ...
      "SEO – Enterprise (₹12,499)",
      "Social Media Full Management – Premium (₹14,999)",
      "Enterprise Email Marketing (₹8,999)",
